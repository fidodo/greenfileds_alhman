...
const UpcomingEvents = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      imageWebp:
        "https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=600&fm=webp",
    ...
    },
    {
      ...
      imageWebp:
        "https://images.unsplash.com/photo-1516594798947-e65505dbb29d?w=600&fm=webp",
      price: "€50 per child",
    ...
    },
    {
      ...
      imageWebp:
        "https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=600&fm=webp",
    ...
    },
    {
      ...
      imageWebp:
        "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&fm=webp",
      price: "€45 per person",
      capacity: "15 people",
      highlights: [
  ...
  return (
    <section className={`${styles.events} ${getSeasonalColor()}`}>
      <div className="container">
        ...
        {/* Newsletter Signup - FIXED VERSION */}
      </div>

      {/* Event Modal - keep as is */}
      {selectedEvent && (
        <div className={styles.modal} onClick={() => setSelectedEvent(null)}>
          ...
          >
            ...
            <picture>
              <source srcSet={selectedEvent.imageWebp} type="image/webp" />
              <img
